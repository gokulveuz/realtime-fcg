...
return [
    ...
    'profile_id' => env('paytabs_profile_id', 150118),
   ...
   */
    ...
    'server_key' => env('paytabs_server_key', 'S6J9W2WLB9-JJRGBZRBBN-WZBJHG6DMM'),
   ...
   */
    ...
    'currency' => env('paytabs_currency', 'INR'),
